...
class Calculator extends extendedCalculator{
    ...
    public static void main(String[] args){
        ...
        float square_res= calc.square(operand_1);
        System.out.println("square result:"+square_res);
        float cube_res= calc.cube(operand_1);
        System.out.println("cube result:"+cube_res);
